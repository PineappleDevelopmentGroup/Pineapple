...
final class HologramSpecAdapter implements SerializedAdapter<HologramSpec> {
    ...
    @Override
    public HologramSpec deserialize(final SerializedElement element, final SerializedDeserializeContext context) throws SerializedAdaptationException {
    ...
    @Override
    public SerializedElement serialize(final HologramSpec spec, final SerializedSerializeContext context) throws SerializedAdaptationException {
