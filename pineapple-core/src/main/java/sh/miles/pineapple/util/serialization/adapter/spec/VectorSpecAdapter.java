...
final class VectorSpecAdapter implements SerializedAdapter<VectorSpec> {
    ...
    @Override
    public VectorSpec deserialize(final SerializedElement element, final SerializedDeserializeContext context) throws SerializedAdaptationException {
    ...
    @Override
    public SerializedElement serialize(final VectorSpec spec, final SerializedSerializeContext context) throws SerializedAdaptationException {
