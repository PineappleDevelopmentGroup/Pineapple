...
class ArmorTrimAdapter implements SerializedAdapter<ArmorTrim> {
    ...
    @Override
    public SerializedElement serialize(final ArmorTrim trim, final SerializedSerializeContext context) throws SerializedAdaptationException {
    ...
    @Override
    public ArmorTrim deserialize(final SerializedElement element, final SerializedDeserializeContext context) throws SerializedAdaptationException {
        final var object = SerializedElement.object();
