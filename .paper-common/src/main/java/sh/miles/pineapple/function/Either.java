...
public sealed class Either<L, R> permits Either.Left, Either.Right {
    ...
    /**
     * Computes a sh.miles.pineapple.function if the type is left
     *
    ...
    /**
     * Computes a sh.miles.pineapple.function if the type is right
     *
     * @param computer the computer
     * @return this either
     */
    ...
    /**
     * Computes a left and right sh.miles.pineapple.function depending on the contained value
     *
